...
namespace Assignment1_Summer2021
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Question 3:
            Console.WriteLine("Q3: Input number of elements in the array :\n");
            int n = Convert.ToInt32(Console.ReadLine());
            int i;
            Console.WriteLine("Q3: Input  elements in the array :\n");
            int[] arr = new int[n];
            for (i = 0; i < n; i++)
            {
            ...
            int[] arr1 = new int[10];
            Console.WriteLine("Q4: Input 10 elements in the array :\n");
            int z;
            for (z = 0; z < 10; z++)
            {
                Console.Write("element - {0} : ", z);
                arr1[z] = Convert.ToInt32(Console.ReadLine());
            }
        ...
        */
        ...
        private static bool CheckIfPangram(string s)
        {
            ...
            /* <logic>
            /// logic: Grouping the string byc haracters and counting if the count of characters is 26
            */
            ...
            /// */
            {
                ...
                return s.ToLower().Where(ch => Char.IsLetter(ch)).GroupBy(ch => ch).Count() == 26;
